            ...
            <!--form start-->
            	<c:choose>
            		...
            		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 message">
			            <form action="/message/getAllList" method="post" id="form_search" role='form'>
			            </form>
						<!--点击跳转详情页-->
		            	...
		            	<c:forEach items="${list}" var="bean">
							<a href="javascript:;" lang="${bean.msg_id}" status="${bean.status}" class="callback_msg all_message" alt="${bean.next_step}">
