    ...
    <div id="wrapper" class="wrapper">
        ...
        <div id="section" class="section normal_width">
            ...
            <div id="main" class="main">
                <form action="/operation/getReturnList" method="post" id="form_search" role="form">
                </form>
...
<script src="/static/js/manufacturing.js" type="text/javascript" charset="UTF-8"></script>
