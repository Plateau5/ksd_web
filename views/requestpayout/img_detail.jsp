    ...
    <div class="row section">
        ...
        <div class="listCon">
            <div class="listConHeader inviteCon" style="margin-bottom:20px;">
                <ul class="crumbs_nav">
                    <li class="inline colorB first_nav"><a class="TS" href="/requestPayout/system">请款管理</a></li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0">
                ...
                <div class="requestpayout_detail_container">
                    ...
                    <div class="requestpayout_detail_btn_box">
                        ...
                        <c:if test="${vo.receipt_id eq 1 }">
	                        <c:if test="${url eq '/requestPayout/waitList' || ((vo.risk_type eq 1 || vo.risk_type eq 2) && vo.already_request eq 0 && url eq '/requestPayout/pass/list')}">
	                                <per:button code="1187">
	                        ...
	                        <c:if test="${url eq '/requestPayout/waitList' && vo.advance_status eq 10 && vo.present_id eq present_id}">
	                            <per:button code="1184">
	                                <a href="javascript:" class="go_forward" data-id="${finance_id}" data-url="${contextParh }/requestPayout/transfer" data-advance_id="${vo.advance_id}">
	                                    <div class="cursor requestpayout_detail_btn requestpayout_care" id="care_btn">转交他人</div>
	                                </a>
	                            </per:button>
	                            <per:button code="1116">
	                                <a href="javascript:" class="go_forward" data-id="${finance_id}" data-url="${contextParh }/requestPayout/toDisagree?type=2" data-advance_id="${vo.advance_id}">
	                                    <div class="cursor requestpayout_detail_btn requestpayout_disagree">不同意</div>
	                                </a>
	                            </per:button>
	                            <per:button code="1115">
	                                <a href="javascript:" class="go_forward" data-id="${finance_id}" data-url="${contextParh }/requestPayout/toAgree" data-advance_id="${vo.advance_id}">
	                                    <div class="cursor requestpayout_detail_btn requestpayout_agree" lang="${finance_id}">同意</div>
	                                </a>
	                            </per:button>
	                        </c:if>
	                        <c:if test="${url eq '/requestPayout/pendingDispose/list'}">
	                            <per:button code="1116">
	                                <a href="javascript:" class="go_forward" data-id="${finance_id}" data-url="${contextParh }/requestPayout/toDisagree?type=1" data-advance_id="${vo.advance_id}">
	                                    <div class="cursor requestpayout_detail_btn requestpayout_disagree">不同意</div>
	                                </a>
	                            </per:button>
	                            <per:button code="1220">
	                        ...
	                        <c:if test="${url eq '/requestPayout/pass/list' && vo.already_request eq 0}">
	                            <per:button code="1220">
	                        ...
	                        <c:if test="${url eq '/requestPayout/pendingPass/list' && vo.risk_type eq 3 && vo.is_OperationCommit eq 0}">
	                            <per:button code="1212">
