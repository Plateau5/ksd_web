...
function SelCity(obj,e, callBack) {
    var ths = obj;
    var dal = '<div class="_citys"><span title="关闭" id="cColse" >×</span><ul id="_citysheng" class="_citys0"><li class="citySel">省份</li><li>城市</li></ul><div id="_citys0" class="_citys1"></div><div style="display:none" id="_citys1" class="_citys1"></div><div style="display:none" id="_citys2" class="_citys1"></div></div>';
    ...
    $("#_citys0 a").click(function () {
        ...
        $("#_citys1 a").click(function () {
            ...
            if (document.getElementById("hproper") == null) {
                ...
                $(ths).after(hcitys);
                //addOwnData($.trim($(this).data("id")), lev);
            }
            else {
            ...
            var cityValue = bc+ "-" + $(this).data("name");
            addOwnData($.trim($(this).data("id")), cityValue);
        ...
        function addOwnData (a, b) {
            ...
            if ($.inArray(thisCity, cityArr) != -1) {
                ...
                var item = '<li class="city" data-id="'+ thisCity +'">'+ cityName +'<em class="delete_btn"></em></li>';
                box.append(item);
